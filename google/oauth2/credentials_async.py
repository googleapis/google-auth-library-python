...
class Credentials(credentials_async.ReadOnlyScoped, credentials_async.Credentials):
    ...
    def from_authorized_user_info(cls, info, scopes=None):
        ...
        Returns:
            google.oauth2.credentials_async.Credentials: The constructed
                credentials.
...
class UserAccessTokenCredentials(credentials_async.Credentials):
    ...
    def with_account(self, account):
        ...
        Returns:
            google.oauth2.credentials_async.UserAccessTokenCredentials: The created
    ...
    @_helpers.copy_docstring(credentials_async.Credentials)
    def async_before_request(self, request, method, url, headers):
