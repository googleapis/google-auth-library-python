...
PKCS11_SO_PATH = "GOOGLE_AUTH_PKCS11_SO_PATH"
"""Environment variable for libpkcs11.so path for PKCS#11 support."""

PKCS11_MODULE_PATH = "GOOGLE_AUTH_PKCS11_MODULE_PATH"
"""Environment variable for TPM module path for PKCS#11 support."""
