...
async def get(request, path, root=_METADATA_ROOT, recursive=False, retry_count=5):
...
async def get_service_account_token(request, service_account="default"):
