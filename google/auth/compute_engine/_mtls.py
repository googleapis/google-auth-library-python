...
@dataclass
class MdsMtlsConfig:
    ca_cert_path: str = _CA_CERT_PATH # path to CA certificate
    client_combined_cert_path: str = _CLIENT_COMBINED_CERT_PATH # path to file containing client certificate and key
