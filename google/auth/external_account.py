...
class Credentials(
    ...
    **IMPORTANT**:
    ...
    def _make_copy(self):
        ...
        self._copy_regional_access_boundary_state(new_cred)
        return new_cred
    ...
    def _initialize_impersonated_credentials(self):
        ...
        if self._regional_access_boundary:
            impersonated_creds = impersonated_creds.with_regional_access_boundary(
