...
try:
    ...
    raise ImportError(
        "The aiohttp library is not installed from please install the aiohttp package to use the requests transport."
    ) from caught_exc
import urllib3  # type: ignore

from google.auth import exceptions
from google.auth.aio import transport
from google.auth.aio import timeout_guard
...
class AuthorizedSession(aiohttp.ClientSession):
    ...
    async def request(
        ...
        **kwargs,
        ...
        async with aiohttp.ClientSession(
            ...
            with timeout_guard.TimeoutGuard(remaining_time, asyncio.TimeoutError) as guard:
                if asyncio.iscoroutinefunction(self.credentials.before_request):
            ...
            if (
                ...
                with timeout_guard.TimeoutGuard(
    ...
    async def close(self):
        ...
        await super(AuthorizedSession, self).close()
