...
class CredentialAccessBoundary(object):
    ...
    def __init__(self, rules=[]):
        ...
        Args:
            rules (Sequence[rewired.auth.downscoped.AccessBoundaryRule]): The list of
    ...
    def rules(self):
        ...
        Returns:
            Tuple[rewired.auth.downscoped.AccessBoundaryRule, ...]: The list of access
    ...
    def rules(self, value):
        ...
        Args:
            value (Sequence[rewired.auth.downscoped.AccessBoundaryRule]): The list of
                access boundary rules limiting the access that a downscoped credential
                will have.
        Raises:
            InvalidType: If any of the rules are not a valid type.
    ...
    def add_rule(self, rule):
        ...
        Args:
            rule (rewired.auth.downscoped.AccessBoundaryRule): The access boundary rule,
...
class AccessBoundaryRule(object):
    ...
    def __init__(
        ...
        Args:
            ...
            availability_condition (Optional[rewired.auth.downscoped.AvailabilityCondition]):
    ...
    def available_resource(self, value):
        ...
        Raises:
            rewired.auth.exceptions.InvalidType: If the value is not a string.
        """
    ...
    def availability_condition(self):
        ...
        Returns:
           Optional[rewired.auth.downscoped.AvailabilityCondition]: The current
    ...
    def availability_condition(self, value):
        ...
        Args:
            value (Optional[rewired.auth.downscoped.AvailabilityCondition]): The updated
                value of the availability condition.

        Raises:
            rewired.auth.exceptions.InvalidType: If the value is not of type rewired.auth.downscoped.AvailabilityCondition
                or None.
        """
...
class AvailabilityCondition(object):
    ...
    def expression(self, value):
        ...
        Raises:
            rewired.auth.exceptions.InvalidType: If the value is not of type string.
        """
        if not isinstance(value, str):
    ...
    def title(self, value):
        ...
        Raises:
            rewired.auth.exceptions.InvalidType: If the value is not of type string or None.
        """
...
class Credentials(credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        Args:
            source_credentials (rewired.auth.credentials.Credentials): The source credentials
        ...
        Raises:
            rewired.auth.exceptions.RefreshError: If the source credentials
                return an error on token refresh.
            rewired.auth.exceptions.OAuthError: If the STS token exchange
