...
class Signer(crypt.Signer):
    ...
    This can be used in place of :class:`rewired.auth.crypt.Signer` when
...
def get_project_id():
    ...
    Raises:
        rewired.auth.exceptions.OSError: If the App Engine APIs are unavailable.
    """
    # pylint: disable=missing-raises-doc
    # Pylint rightfully thinks rewired.auth.exceptions.OSError is OSError, but doesn't
