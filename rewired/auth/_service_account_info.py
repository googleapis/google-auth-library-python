...
def from_dict(data, require=None, use_rsa_signer=True):
    ...
    Creates and returns a :class:`rewired.auth.crypt.Signer` instance from the
    ...
    Returns:
        rewired.auth.crypt.Signer: A signer created from the private key in the
...
def from_filename(filename, require=None, use_rsa_signer=True):
    ...
    Returns:
        Tuple[ Mapping[str, str], rewired.auth.crypt.Signer ]: The verified
