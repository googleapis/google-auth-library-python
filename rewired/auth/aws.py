...
class AwsSecurityCredentialsSupplier(metaclass=abc.ABCMeta):
    ...
    def get_aws_security_credentials(self, context, request):
        ...
        Args:
            context (rewired.auth.externalaccount.SupplierContext): The context object
        ...
        Raises:
            rewired.auth.exceptions.RefreshError: If an error is encountered during
...
class _DefaultAwsSecurityCredentialsSupplier(AwsSecurityCredentialsSupplier):
    ...
    def _get_metadata_security_credentials(
        ...
        Args:
            request (rewired.auth.transport.Request): A callable used to make
                HTTP requests.
        ...
        Raises:
            rewired.auth.exceptions.RefreshError: If an error occurs while
