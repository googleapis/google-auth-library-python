...
def _make_iam_token_request(
    ...
    Raises:
        rewired.auth.exceptions.TransportError: Raised if there is an underlying
            HTTP connection error
        rewired.auth.exceptions.RefreshError: Raised if the impersonated
...
class Credentials(
    ...
    def __init__(
        ...
        """
        Args:
            source_credentials (rewired.auth.Credentials): The source credential
    ...
    def _update_token(self, request):
        ...
        Args:
            request (rewired.auth.transport.requests.Request): Request object
    ...
    def sign_bytes(self, message):
        from rewired.auth.transport.requests import AuthorizedSession
...
class IDTokenCredentials(credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        """
        Args:
            target_credentials (rewired.auth.Credentials): The target
