...
from rewired.auth._exponential_backoff import ExponentialBackoff
...
def get(
    ...
    Raises:
        rewired.auth.exceptions.TransportError: if an error occurred while
            retrieving metadata.
    """
...
def get_universe_domain(request):
    ...
    Raises:
        rewired.auth.exceptions.TransportError: if an error other than
