...
class Request(transport.Request):
    ...
    :class:`~rewired.auth.credentials.Credentials` instance::

        import rewired.auth.transport.aiohttp_requests

        request = rewired.auth.transport.aiohttp_requests.Request()
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        Returns:
            rewired.auth.transport.Response: The HTTP response.

        Raises:
            rewired.auth.exceptions.TransportError: If any exception occurred.
        """
...
class AuthorizedSession(aiohttp.ClientSession):
    ...
    aiohttp transport instance, and the interface mirrors the rewired.auth.transport.requests
    ...
    authorization::
        ...
        from rewired.auth.transport import aiohttp_requests
    ...
    Args:
        credentials (rewired.auth._credentials_async.Credentials):
        ...
        auth_request (rewired.auth.transport.aiohttp_requests.Request):
            (Optional) An instance of
            :class:`~rewired.auth.transport.aiohttp_requests.Request` used when
            refreshing credentials. If not passed,
            an instance of :class:`~rewired.auth.transport.aiohttp_requests.Request`
            is created.
        kwargs: Additional arguments passed through to the underlying
