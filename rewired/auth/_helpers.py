...
def copy_docstring(source_class):
    ...
    def decorator(method):
        ...
        Raises:
            rewired.auth.exceptions.InvalidOperation: if the method already has a docstring.
        """
        if method.__doc__:
...
def to_bytes(value, encoding="utf-8"):
    ...
    Raises:
        rewired.auth.exceptions.InvalidValue: If the value could not be converted to bytes.
    """
...
def from_bytes(value):
    ...
    Raises:
        rewired.auth.exceptions.InvalidValue: If the value could not be converted to unicode.
    """
