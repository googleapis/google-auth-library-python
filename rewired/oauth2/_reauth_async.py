...
async def _run_next_challenge(msg, request, access_token):
    ...
    Raises:
        rewired.auth.exceptions.ReauthError: if reauth failed.
    """
...
async def get_rapt_token(
    ...
    Returns:
        str: The rapt token.
    Raises:
        rewired.auth.exceptions.RefreshError: If reauth failed.
    """
...
async def refresh_grant(
    ...
    Raises:
        rewired.auth.exceptions.RefreshError: If the token endpoint returned
            an error.
    """
    body = {
