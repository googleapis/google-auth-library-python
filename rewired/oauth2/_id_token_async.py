...
:class:`rewired.auth.transport.Request`::
    ...
    request = rewired.auth.transport.requests.Request(session=cached_session)
...
async def fetch_id_token(request, audience):
    ...
    3. If metadata server doesn't exist and no valid service account credentials
       are found, :class:`~rewired.auth.exceptions.DefaultCredentialsError` will
       be raised.
    ...
    Args:
        request (rewired.auth.transport.aiohttp_requests.Request): A callable used to make
            HTTP requests.
