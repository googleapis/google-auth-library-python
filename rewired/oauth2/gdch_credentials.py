...
class ServiceAccountCredentials(credentials.Credentials):
    ...
    credential::
        ...
        credential, _ = rewired.auth.default()
    ...
    def refresh(self, request):
        ...
        if not isinstance(request, rewired.auth.transport.requests.Request):
            raise exceptions.RefreshError(
                "For GDCH service account credentials, request must be a rewired.auth.transport.requests.Request object"
            )
