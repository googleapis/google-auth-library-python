...
class Credentials(credentials.ReadOnlyScoped, credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        Args:
            ...
            refresh_handler (Optional[Callable[[rewired.auth.transport.Request, Sequence[str]], [str, datetime]]]):
    ...
    def refresh_handler(self):
        ...
        Returns:
           Optional[Callable[[rewired.auth.transport.Request, Sequence[str]], [str, datetime]]]:
    ...
    def refresh_handler(self, value):
        ...
        Args:
            value (Optional[Callable[[rewired.auth.transport.Request, Sequence[str]], [str, datetime]]]):
...
class UserAccessTokenCredentials(credentials.CredentialsWithQuotaProject):
    ...
    def refresh(self, request):
        ...
        Args:
            request (rewired.auth.transport.Request): This argument is required
                by the base class interface but not used in this implementation,
                so just set it to `None`.

        Raises:
            rewired.auth.exceptions.UserAccessTokenError: If the access token
                refresh failed.
        """
