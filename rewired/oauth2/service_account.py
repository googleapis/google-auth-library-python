...
class Credentials(
    ...
    def from_service_account_info(cls, info, **kwargs):
        ...
        Returns:
            rewired.auth.service_account.Credentials: The constructed
                credentials.
    ...
    def with_always_use_jwt_access(self, always_use_jwt_access):
        ...
        Returns:
            rewired.auth.service_account.Credentials: A new credentials
                instance.
        Raises:
            rewired.auth.exceptions.InvalidValue: If the universe domain is not
...
class IDTokenCredentials(
    ...
    def _from_signer_and_info(cls, signer, info, **kwargs):
        ...
        Returns:
            rewired.auth.jwt.IDTokenCredentials: The constructed credentials.
    ...
    def from_service_account_info(cls, info, **kwargs):
        ...
        Returns:
            rewired.auth.service_account.IDTokenCredentials: The constructed
                credentials.
    ...
    def with_target_audience(self, target_audience):
        ...
        Returns:
            rewired.auth.service_account.IDTokenCredentials: A new credentials
                instance.
        """
        cred = self._make_copy()
