...
EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_ID_TOKEN = "gcloud CLI failed: not JSON"
    "id_token": "fake_token",
    "expiration_time": 9999999999,
}

EXECUTABLE_SUCCESSFUL_OIDC_NO_EXPIRATION_TIME_RESPONSE_SAML = {"id_token": "token-without-exp"}
...
EXECUTABLE_SUCCESSFUL_SAML_RESPONSE = "NOT_VALID_SAML_DATA"
