...
class TestCredentials(object):
    ...
    EXPECTED_REGIONAL_ACCESS_BOUNDARY_LOOKUP_URL = "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/default/allowedLocations"
    ...
    def test_with_regional_access_boundary(self):
        ...
        new_creds = creds._with_regional_access_boundary(new_boundary)
