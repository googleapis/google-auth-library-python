...
class TestIDTokenCredentials(object):
    ...
    def test_refresh_success(self, id_token_jwt_grant, sign, get, utcnow):
        ...
        id_token_jwt_grant.side_effect = [
            ("idtoken", datetime.datetime.fromtimestamp(3600, datetime.timezone.utc), {})
        ]
        ...
        assert self.credentials.expiry == (datetime.datetime.fromtimestamp(3600, datetime.timezone.utc))
    ...
    def test_get_id_token_from_metadata(
        ...
        assert cred.expiry == datetime.datetime.fromtimestamp(SAMPLE_ID_TOKEN_EXP, datetime.timezone.utc)
