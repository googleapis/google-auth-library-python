...
def test_load_provider_lib():
    ...
    assert "failed to get certificate" in str(excinfo.value)
    ...
    signer_object.load_libraries()
    assert "enterprise cert file is invalid" in str(excinfo.value)
    ...
    signer_object.attach_to_ssl_context(mock.MagicMock()
    assert "failed to configure ECP Offload SSL context" in str(excinfo.value)
    ...
    signer_object.attach_to_ssl_context(mock.MagicMock()
    assert "failed to configure ECP Provider SSL context" in str(excinfo.value)
    ...
    signer_object.attach_to_ssl_context(mock.MagicMock()
    assert "Invalid ECP configuration." in str(excinfo.value)
