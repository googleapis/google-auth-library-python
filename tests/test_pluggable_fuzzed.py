...
EXECUTABLE_OIDC_TOKEN = None
EXECUTABLE_SUCCESSFUL_OIDC_NO_EXPIRATION_TIME_RESPONSE_JWT = {"id_token": "mock-jwt-response", "expiration_time": None}
EXECUTABLE_SUCCESSFUL_OIDC_NO_EXPIRATION_TIME_RESPONSE_JWT = {"id_token": "mock-jwt-response", "expiration_time": None}
EXECUTABLE_SUCCESSFUL_OIDC_NO_EXPIRATION_TIME_RESPONSE_JWT = {"id_token": "mock-jwt-response", "expiration_time": None}
CREDENTIAL_SOURCE_EXECUTABLE = {"unsupported": "source"}
EXECUTABLE_SUCCESSFUL_OIDC_NO_EXPIRATION_TIME_RESPONSE_SAML = {"id_token": "no-exp"}
EXECUTABLE_SUCCESSFUL_OIDC_RESPONSE_ID_TOKEN = "INVALID_JSON_OUTPUT"
EXECUTABLE_SUCCESSFUL_SAML_RESPONSE = "<SAML>INVALID</SAML>"
