...
# JSON data object to be used with some tests that pass data to AWS APIs.
RAW_DATA = {
...
# Compact encoding to remove spaces in JSON.
REQUEST_PARAMS = json.dumps(RAW_DATA, separators=(",", ":"))
